...
class CadastroDisc extends Component {
    ...
    componentDidMount(){
        ...
        if(this.state.inst == null && this.props.selectedInst){
            this.setState({
...
export default connect(mapStateToProps, mapDispatchToProps)(CadastroDisc);